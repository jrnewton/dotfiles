" modified version of PeachPuff, to use 'wheat' as background color. 
"
...
let g:colors_name = "wheatpuff"

hi Normal guibg=wheat guifg=Black
...
hi StatusLineNC term=reverse cterm=reverse gui=bold guifg=wheat guibg=Gray45
